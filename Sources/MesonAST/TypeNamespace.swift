  ...
  public init() {
    ...
    self.functions = [
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "c_static_args", opt: true, types: strlistL),
          Kwarg(name: "cpp_static_args", opt: true, types: strlistL),
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "c_static_args", opt: true, types: strlistL),
          Kwarg(name: "c_shared_args", opt: true, types: strlistL),
          Kwarg(name: "cpp_args", opt: true, types: strlistL),
          Kwarg(name: "cs_args", opt: true, types: strlistL),
          Kwarg(name: "cuda_args", opt: true, types: strlistL),
          Kwarg(name: "d_args", opt: true, types: strlistL),
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "macro_name", opt: true, types: strL),
          ...
          Kwarg(name: "install", opt: true, types: boolL),
          Kwarg(name: "install_dir", opt: true, types: [str, boolt]),
          Kwarg(name: "install_mode", opt: true, types: [ListType(types: sil)]),
          ...
          Kwarg(
            ...
            types: [
              ListType(types: [
                ...
                self.types["generated_list"]!, self.types["extracted_obj"]!,
              ])
            ]
          ), Kwarg(name: "install", opt: true, types: boolL),
          Kwarg(name: "install_dir", opt: true, types: strL),
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(
            ...
            types: [
              ListType(types: [
                self.types["dep"]!, self.types["str"]!, self.types["file"]!,
          ...
          Kwarg(
            ...
            types: [
              ListType(types: [
                self.types["extracted_obj"]!, self.types["file"]!, str, self.types["custom_idx"]!,
                self.types["custom_tgt"]!, self.types["generated_list"]!,
                self.types["extracted_obj"]!,
              ])
            ]
          ),
          Kwarg(
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "follow_symlinks", opt: true, types: boolL),
      ...
      Function(
        ...
        args: [
          PositionalArgument(
            name: "message",
            opt: true,
            types: [str, intt, boolt, ListType(types: silb), Dict(types: silb), self.types["env"]!]
          ),
          PositionalArgument(
            name: "msg",
            varargs: true,
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(
            ...
            types: [
              ListType(types: [
                self.types["extracted_obj"]!, self.types["file"]!, str, self.types["custom_tgt"]!,
              ])
            ]
          ),
          Kwarg(
      ...
      Function(
        ...
        args: [
          ...
          PositionalArgument(
            ...
            types: [
              self.types["exe"]!, self.types["jar"]!, self.types["external_program"]!,
              self.types["file"]!, self.types["tgt"]!,
            ]
          ),
          Kwarg(
            name: "args",
    ...
    self.vtables["int"] = [
      ...
      Method(
        ...
        parent: t,
        returnTypes: strL,
        args: [Kwarg(name: "fill", opt: true, types: inttL)]
      ),
    ]
    t = self.types["list"]!
    self.vtables["list"] = [
        ...
        args: [
          PositionalArgument(
            ...
            types: [
              ...
              self.types["custom_tgt"]!, self.types["custom_idx"]!, self.types["run_tgt"]!,
            ]
          ),
          PositionalArgument(
            name: "arg",
      ...
      Method(
        ...
        args: [
          PositionalArgument(
            ...
            opt: true,
            types: [
              intt, boolt, t, self.types["file"]!, self.types["custom_tgt"]!, self.types["env"]!,
            ]
          )
        ]
      ),
    ...
    self.vtables["compiler"] = [
      ...
      Method(
        ...
        returnTypes: boolL,
        args: [
          PositionalArgument(name: "argument", types: strL),
          Kwarg(name: "required", opt: true, types: [boolt, self.types["feature"]!]),
        ]
      ),
      Method(
    ...
    self.vtables["cmake_module"] = [
      ...
      Method(
        ...
        args: [
          ...
          Kwarg(name: "configuration", types: [self.types["cfg_data"]!, Dict(types: strL)]),
          Kwarg(name: "install_dir", opt: true, types: strL),
        ]
      ),
    ]
    ...
    self.vtables["cmake_subproject"] = [
      ...
      Method(
        ...
        args: [PositionalArgument(name: "tgt", types: [self.types["cmake_tgt"]!, str])]
      ),
      Method(
        name: "target_type",
        parent: t,
        returnTypes: strL,
        args: [
          PositionalArgument(name: "tgt", types: [self.types["cmake_tgt"]!, self.types["str"]!])
        ]
    ...
    self.vtables["cmake_subprojectoptions"] = [
      ...
      Method(
        ...
        args: [
          ...
          Kwarg(name: "target", opt: true, types: [self.types["cmake_tgt"]!, self.types["str"]!]),
        ]
      ),
      Method(
        name: "set_install",
    ...
    self.vtables["hotdoc_module"] = [
      ...
      Method(
        ...
        args: [
          ...
          Kwarg(name: "c_smart_index", opt: true, types: [str, boolt]),
          Kwarg(
            name: "c_sources",
            opt: true,
            types: [strlist, ListType(types: [self.types["file"]!])]
          ), Kwarg(name: "languages", opt: true, types: [ListType(types: strL)]),
    ...
    self.vtables["python_installation"] = [
      ...
      Method(
        ...
        args: [
          ...
          Kwarg(name: "install_rpath", opt: true, types: strL),
          Kwarg(name: "install_tag", opt: true, types: strL),
          Kwarg(name: "limited_api", opt: true, types: strL),
    ...
    self.vtables["rust_module"] = [
      ...
      Method(
        ...
        args: [
          PositionalArgument(name: "name", types: strL),
          PositionalArgument(name: "tgt", types: [self.types["build_tgt"]!, self.types["tgt"]!]),
          Kwarg(
            name: "args",
            opt: true,
            types: [
    ...
    self.vtables["sourceset"] = [
      ...
      Method(
        ...
        args: [
          PositionalArgument(
            name: "cfg",
            types: [self.types["cfg_data"]!, Dict(types: [str, boolt])]
