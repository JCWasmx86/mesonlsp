    ...
    self.functions = [
      Function(
        ...
        args: [
          ...
          Kwarg(name: "language", types: [strlist]),
      ...
      Function(
        ...
        args: [
          ...
          ), Kwarg(name: "exclude_suites", opt: true, types: [strlist]),
          Kwarg(
            name: "exe_wrapper",
            opt: true,
      ...
      Function(
        ...
        args: [
          ...
          ), Kwarg(name: "c_args", opt: true, types: [strlist]),
          Kwarg(name: "cpp_args", opt: true, types: [strlist]),
          Kwarg(name: "cs_args", opt: true, types: [strlist]),
          Kwarg(name: "cuda_args", opt: true, types: [strlist]),
          Kwarg(name: "d_args", opt: true, types: [strlist]),
          Kwarg(name: "fortran_args", opt: true, types: [strlist]),
          Kwarg(name: "java_args", opt: true, types: [strlist]),
          Kwarg(name: "objc_args", opt: true, types: [strlist]),
          Kwarg(name: "objcpp_args", opt: true, types: [strlist]),
          Kwarg(name: "rust_args", opt: true, types: [strlist]),
          Kwarg(name: "vala_args", opt: true, types: [strlist]),
          Kwarg(name: "cython_args", opt: true, types: [strlist]),
          Kwarg(name: "nasm_args", opt: true, types: [strlist]),
          Kwarg(name: "masm_args", opt: true, types: [strlist]),
          Kwarg(name: "c_pch", opt: true, types: [Str()]),
          Kwarg(name: "cpp_pch", opt: true, types: [Str()]),
          Kwarg(name: "resources", opt: true, types: [Str()]),
          Kwarg(name: "vala_header", opt: true, types: [Str()]),
          Kwarg(name: "vala_vapi", opt: true, types: [Str()]),
          Kwarg(name: "vala_gir", opt: true, types: [Str()]),
          Kwarg(name: "build_by_default", opt: true, types: [BoolType()]),
          Kwarg(name: "build_rpath", opt: true, types: [Str()]),
          Kwarg(name: "d_debug", opt: true, types: [strlist]),
          Kwarg(name: "d_import_dirs", opt: true, types: [strlist]),
          Kwarg(
          ...
          Kwarg(name: "link_args", opt: true, types: [strlist]),
          ...
          ), Kwarg(name: "override_options", opt: true, types: [strlist]),
      ...
      Function(
        ...
        args: [
          PositionalArgument(
            name: "data",
            opt: true,
            types: [Dict(types: [Str(), BoolType(), `IntType`()])]
          )
        ]
      ),
      Function(
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "install_mode", opt: true, types: [ListType(types: [Str(), `IntType`()])]),
          Kwarg(name: "install_tag", opt: true, types: [Str()]),
          Kwarg(name: "output", types: [strlist]),
        ]
      ),
      Function(
        name: "debug",
      ...
      Function(
        ...
        returnTypes: [Dep()],
        args: [
          Kwarg(name: "compile_args", opt: true, types: [strlist]),
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "components", opt: true, types: [strlist]),
          Kwarg(name: "main", opt: true, types: [BoolType()]),
          Kwarg(name: "private_headers", opt: true, types: [BoolType()]),
          ...
          Kwarg(name: "modules", opt: true, types: [Str(), ListType(types: [Str()])]),
          Kwarg(name: "optional_modules", opt: true, types: [Str(), ListType(types: [Str()])]),
          Kwarg(name: "native", opt: true, types: [BoolType()]),
          ...
          Kwarg(name: "version", opt: true, types: [Str()]),
          Kwarg(name: "cmake_package_version", opt: true, types: [Str()]),
        ]
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "dirs", opt: true, types: [strlist]),
          Kwarg(name: "disabler", opt: true, types: [BoolType()]),
          Kwarg(name: "native", opt: true, types: [BoolType()]),
          Kwarg(name: "required", opt: true, types: [BoolType(), Feature()]),
          Kwarg(name: "version", opt: true, types: [Str()]),
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "arguments", opt: true, types: [strlist]),
          Kwarg(name: "capture", opt: true, types: [BoolType()]),
          Kwarg(name: "depends", opt: true, types: [ListType(types: [BuildTgt(), CustomTgt()])]),
          Kwarg(name: "depfile", opt: true, types: [Str()]),
          Kwarg(name: "output", opt: true, types: [strlist]),
        ]
      ),
      Function(
        name: "get_option",
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "rename", opt: true, types: [strlist]),
      ...
      Function(
        ...
        args: [
          ...
          Kwarg(name: "exclude_directories", opt: true, types: [strlist]),
          Kwarg(name: "exclude_files", opt: true, types: [strlist]),
          Kwarg(name: "install_dir", opt: true, types: [Str()]),
          Kwarg(name: "install_mode", opt: true, types: [ListType(types: [Str(), `IntType`()])]),
          Kwarg(name: "install_tag", opt: true, types: [Str()]),
      ...
      Function(
        ...
        args: [
          Kwarg(
            ...
            opt: true,
            types: [ListType(types: [Exe(), ExternalProgram(), CustomTgt(), File(), Str()])]
          ), Kwarg(name: "fallback", opt: true, types: [Str()]),
          Kwarg(name: "input", types: [Str()]), Kwarg(name: "output", types: [Str()]),
