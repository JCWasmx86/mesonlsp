    ...
    self.methods = [
      ...
      Method(
        ...
        args: [
          ...
          PositionalArgument(
            name: "arg", varargs: true, opt: true, types: [Str(), File(), ExternalProgram()]),
        ]),
      Method(
      ...
      Method(
        name: "has_external_property", parent: self, returnTypes: [BoolType()],
        args: [
          PositionalArgument(name: "propname", types: [Str()]),
          Kwarg(name: "native", opt: true, types: [BoolType()]),
