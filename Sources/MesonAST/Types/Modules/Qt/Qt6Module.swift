public struct Qt6Module: AbstractObject {
  public let name: String = "qt6_module"
  ...
  public init() {
    self.methods = [
      Method(
        name: "compile_resources", parent: self, returnTypes: [ListType(types: [CustomTgt()])],
        args: [
          Kwarg(name: "name", opt: true, types: [Str()]),
          Kwarg(
            name: "sources", types: [Str(), File(), CustomTgt(), CustomIdx(), GeneratedList()]),
          Kwarg(name: "extra_args", opt: true, types: [ListType(types: [Str()])]),
          Kwarg(name: "method", opt: true, types: [Str()]),
        ]),
      // TODO: Return values?
      Method(
        name: "compile_ui", parent: self, returnTypes: [ListType(types: [CustomTgt()])],
        args: [
          Kwarg(
            name: "sources", types: [Str(), File(), CustomTgt(), CustomIdx(), GeneratedList()]),
          Kwarg(name: "extra_args", opt: true, types: [ListType(types: [Str()])]),
      ...
      // TODO: Return values?
      Method(
        name: "compile_moc", parent: self, returnTypes: [ListType(types: [CustomTgt()])],
        args: [
          Kwarg(
            name: "sources", opt: true,
            types: [Str(), File(), CustomTgt(), CustomIdx(), GeneratedList()]),
          Kwarg(
            name: "headers", opt: true,
            types: [Str(), File(), CustomTgt(), CustomIdx(), GeneratedList()]),
          Kwarg(name: "extra_args", opt: true, types: [ListType(types: [Str()])]),
          Kwarg(name: "method", opt: true, types: [Str()]),
      ...
      // TODO: Return values?
      Method(
        name: "preprocess", parent: self, returnTypes: [ListType(types: [CustomTgt()])],
        args: [
          Kwarg(name: "sources", opt: true, types: [ListType(types: [Str(), File()])]),
          Kwarg(name: "qresources", opt: true, types: [ListType(types: [Str(), File()])]),
          Kwarg(
            name: "ui_files", opt: true, types: [ListType(types: [Str(), File(), CustomTgt()])]),
          Kwarg(
            name: "moc_sources", opt: true, types: [ListType(types: [Str(), File(), CustomTgt()])]),
          Kwarg(
            name: "moc_headers", opt: true, types: [ListType(types: [Str(), File(), CustomTgt()])]),
      ...
      // TODO: Return values?
      Method(
        name: "compile_translations", parent: self, returnTypes: [ListType(types: [CustomTgt()])],
        args: [
      ...
      Method(
        name: "compile_translations", parent: self, returnTypes: [BoolType()],
        args: [
