public struct JavaModule: AbstractObject {
  ...
  public init() {
    self.methods = [
      Method(
        name: "generate_native_header", parent: self, returnTypes: [CustomTgt()],
        args: [
          PositionalArgument(
            name: "files", varargs: true, opt: true,
            types: [Str(), File(), Tgt(), CustomIdx(), GeneratedList()]),
          Kwarg(name: "package", opt: true, types: [Str()]),
        ]),
      Method(
        name: "generate_native_headers", parent: self, returnTypes: [CustomTgt()],
        args: [
          PositionalArgument(
            name: "files", varargs: true, opt: true,
            types: [Str(), File(), Tgt(), CustomIdx(), GeneratedList()]),
      ...
      Method(
        name: "native_headers", parent: self, returnTypes: [CustomTgt()],
        args: [
          PositionalArgument(
            name: "files", varargs: true, opt: true,
            types: [Str(), File(), Tgt(), CustomIdx(), GeneratedList()]),
