public struct PkgconfigModule: AbstractObject {
  ...
  public init() {
    self.methods = [
      Method(
        name: "generate", parent: self, returnTypes: [ExternalProgram()],
        args: [
          ...
          Kwarg(
            name: "unescaped_variables", opt: true,
            types: [ListType(types: [Str()]), Dict(types: [Str()])]),
          Kwarg(
            name: "uninstalled_variables", opt: true,
            types: [ListType(types: [Str()]), Dict(types: [Str()])]),
          Kwarg(
            name: "unescaped_uninstalled_variables", opt: true,
            types: [ListType(types: [Str()]), Dict(types: [Str()])]),
          Kwarg(
