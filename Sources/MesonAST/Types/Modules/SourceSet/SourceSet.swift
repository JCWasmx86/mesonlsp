public struct SourceSet: AbstractObject {
  ...
  public init() {
    self.methods = [
      ...
      Method(
        name: "all_sources", parent: self, returnTypes: [ListType(types: [Str(), File()])], args: []
      ),
      Method(
        name: "all_dependencies", parent: self, returnTypes: [ListType(types: [Str(), File()])],
        args: []),
      Method(
        name: "apply", parent: self, returnTypes: [SourceFiles()],
        args: [
