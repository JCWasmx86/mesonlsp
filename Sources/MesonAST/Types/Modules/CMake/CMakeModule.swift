public struct CMakeModule: AbstractObject {
  ...
  public init() {
    self.methods = [
      Method(
        name: "subproject", parent: self, returnTypes: [CMakeSubproject()],
        args: [
      ...
      Method(
        name: "subproject_options", parent: self, returnTypes: [CMakeSubprojectOptions()], args: []),
      Method(
        name: "write_basic_package_version_file", parent: self, returnTypes: [],
        args: [
      ...
      Method(
        name: "configure_package_config_file", parent: self, returnTypes: [],
        args: [
