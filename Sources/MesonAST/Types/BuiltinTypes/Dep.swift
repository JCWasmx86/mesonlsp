public struct Dep: AbstractObject {
  ...
  public init() {
    self.methods = [
      ...
      Method(
        name: "get_variable", parent: self, returnTypes: [Str()],
        args: [
      ...
      Method(
        name: "partial_dependency", parent: self, returnTypes: [self],
        args: [
